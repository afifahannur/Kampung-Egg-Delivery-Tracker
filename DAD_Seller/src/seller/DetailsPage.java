...
public class DetailsPage {
    ...
    private void initialize() {
     ...
     // Back button (directly go to ViewOrder GUI without confirmation)
        ...
        // Delete/Exit button
        JButton btnDelete = new JButton(new ImageIcon(new ImageIcon("C:\\UTeM SEM IV\\Application\\Delete2R.png")
                .getImage().getScaledInstance(100, 100, Image.SCALE_SMOOTH)));
        ...
        btnDelivered.addActionListener(e -> {
            try {
                URL url = new URL("http://192.168.0.39/eggdelivery/update_delivery_status.php");
