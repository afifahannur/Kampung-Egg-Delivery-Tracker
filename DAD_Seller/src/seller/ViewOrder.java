...
public class ViewOrder {
    ...
    private void initialize() {
        ...
        JButton btnBack = new JButton(new ImageIcon(new ImageIcon("C:\\UTeM SEM IV\\Application\\BACK_4.png")
        ...
        JButton btnExit = new JButton(new ImageIcon(new ImageIcon("C:\\UTeM SEM IV\\Application\\Delete2R.png")
                .getImage().getScaledInstance(100, 100, Image.SCALE_SMOOTH)));
    ...
    private void loadData(DefaultTableModel model) {
        try {
            URL url = new URL("http://192.168.0.39/eggdelivery/get_all_orders.php");
            ...
            for (int i = 0; i < orders.length(); i++) {
                ...
                if (status.equals("Pending")) {
                    ...
                    actionButton.addActionListener(e -> {
                        updateStatus("http://192.168.0.39/eggdelivery/update_order_status.php", orderId, "Preparing");
                    });
    ...
    private void updateOnTheWay(int orderId, double lat, double lng) throws IOException {
        URL url = new URL("http://192.168.0.39/eggdelivery/update_on_the_way.php");
        HttpURLConnection conn = (HttpURLConnection) url.openConnection();
        conn.setRequestMethod("POST");
        conn.setRequestProperty("Content-Type", "application/x-www-form-urlencoded");
        conn.setDoOutput(true);
